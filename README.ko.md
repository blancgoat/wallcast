...
어디에 놓을지 정하며, 그 사각형 안쪽은 언제나 가운데 정렬입니다. 남는 자리가 있어야 의미가 있으므로, 없으면 그리드가 비활성으로 바뀝니다 — 16:9 캡처를
16:9 모니터에 통째로 올리면 이미 전부 덮고 있고, 화면에 늘린 경우도 마찬가지입니다. 자르기 자체는
...
고정 16:9 / 4:3 항목은 없습니다. 자르기 기준에서는 사용자 크기를 어설프게 적은 것에 불과하고,
