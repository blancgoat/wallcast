...
- **누르면 눌립니다** (베타). 바탕화면을 클릭하면 블루투스로 기기에 탭이 전달됩니다. 그림이 기기
  화면과 정확히 같을 때 제대로 맞습니다. 원본의 검은 여백이 남는 배치로 바꾸면 그만큼 어긋납니다.

## 설치

Windows 10 또는 11, x64. [Releases](https://github.com/blancgoat/wallcast/releases)에서
`Wallcast-v1.3.0-beta.1-win-x64.zip`을 받아 아무 곳에나 풀고 `Wallcast\Wallcast.exe`를 실행하세요.
