...
Windows용 작은 영상 바탕화면 앱. 동영상 또는 캡처 장치 하나를 선택해 모니터 하나의 바탕화면 아이콘 뒤에 표시합니다.
...
| 색 범위 | **Limited**, Full |
| 표시 비율 | **Input resolution**, 16:9, 4:3, 16:10, Stretch to screen |
...
Live Gamer BOLT는 우선 **NV12 / 1920×1080 / 60 / Rec.709 / Limited / Input resolution**로 사용하세요. 검정이 뜨거나 어두운 부분이 뭉개지면 실제 소스에 맞게 색 범위를 변경하세요. 이전 버전처럼 전체 입력을 강제로 4:3으로 압축하지 않습니다. 원본에 포함된 검은 여백은 그대로 유지합니다.
