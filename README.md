...
| 색 범위 | **제한 (Limited)**, 전체 (Full) |
| 표시 비율 | **입력 해상도**, 16:9, 4:3, 16:10, 화면에 늘이기 |
...
Live Gamer BOLT는 우선 **NV12 / 1920×1080 / 60 / Rec.709 / Limited / 입력 해상도**로 사용하세요. 검정이 뜨거나 어두운 부분이 뭉개지면 실제 소스에 맞게 색 범위를 변경하세요. 이전 버전처럼 전체 입력을 강제로 4:3으로 압축하지 않습니다. 원본에 포함된 검은 여백은 그대로 유지합니다.
